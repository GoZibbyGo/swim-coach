...
export const FEEDBACK_SIGNALS = [
  ...
  { id: 'session_completed_explicit', category: 'adherence', applies_to: ['both'], severity: 'info', decay: 'this',
    ...
    effects: { note: true } },
  { id: 'illness_recent', category: 'health', applies_to: ['both'], severity: 'high', decay: { sessions: 3 },
    phrases: ['back from a cold', 'recovering from a cold', 'had the flu', 'been sick',
      'getting over a cold', 'just got over', 'was ill', 'been unwell', 'coming off a cold',
      'still congested', 'chest infection'],
    effects: { flag: 'illness_recent', note: true } },
