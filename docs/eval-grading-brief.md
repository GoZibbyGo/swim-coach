...
> **Important:** the performances are **synthetically generated**, not real swims — so do **not** critique the athlete or read into "results." Judge the system's **coaching logic**: were the plans well-designed, and was the feedback the kind a great coach would write *given that data*?
